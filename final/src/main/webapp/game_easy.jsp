    ...
    <body>
        ...
        <div class="main">
            <span>
                ...
                <a href="index_ok.jsp" style="font-size:20px"><strong>메인으로</strong></a>
                <a href="game.html" style="font-size:20px"><strong>이전화면</strong></a><br><br>
            </span>
        ...
        <script>
            ...
            window.onload=function(){                    
                for(let i=0; i<x; i++){
                    ...
                    if(t==0) tds[i].src="media/down.png";
            ...
            function next(){
                ...
                let t=Math.floor(Math.random()*2);
                if(t==0) tds[9].src="http://localhost:8080/final/media/down.png";
            ...
            window.onkeydown=function(e){
                ...
                if(tds[0].src=="http://localhost:8080/final/media/down.png") y=0;
                else y=1;

                if(presskey=='down' && y==0 || presskey=='up' && y==1){
                    let score=document.getElementById("score");
                    cnt++;
                    score.innerHTML=cnt;
                    next();
                }
                else if(presskey!='down' && presskey!='up'){
                    return;
                }
            }
        </script>
        <form action="ranking_easy_post.jsp" method="post">
        	<div id="control">
